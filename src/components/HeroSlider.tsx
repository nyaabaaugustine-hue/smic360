  ...
  return (
    <section className="hero">
            ...
            <div className="hero-content">
              <div className="hero-left">
                ...
                <div className="hero-btns">
                  ...
                  <button onClick={onBookClick} className="btn btn-outline-white">{slide.btn2}</button>
                </div>
                {i === 0 &&
              <div className="hero-stats">
                    <div className="hero-stat">
                      <div className="hero-stat-num">150<span>+</span></div>
              ...
              <div className="hero-card">
                ...
                <div className="hero-card-body">
                  ...
                  <span key={j} className="hero-tag-pill">{tag}</span>
                  )}
                  </div>
                </div>
              </div>
      ...
      <div className="hero-dots">
        {slides.map((_, i) =>
        <div key={i} className={`hero-dot${activeIdx === i ? ' active' : ''}`} onClick={() => jumpTo(i)}></div>
        )}
      </div>
    </section>);
