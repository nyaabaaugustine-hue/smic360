      ...
      <div className="topbar-inner">
        <div className="topbar-left">
          <a href="tel:0244783099" className="topbar-item">
            ...
            <span style={{ color: 'var(--gold)', fontWeight: 600 }}>024 478 3099</span>
          </a>
          ...
          <span
            ...
            style={{ color: 'rgba(255,193,7,0.7)', fontSize: '11px', letterSpacing: '1px' }}
          >
            📍 Spintex Road, Accra — Ghana
          </span>
        </div>
        <div className="topbar-right">
          <Link href="/about" className="topbar-item">
            About
          </Link>
          <Link href="/portfolio" className="topbar-item">
            Portfolio
          </Link>
          {/* <a
