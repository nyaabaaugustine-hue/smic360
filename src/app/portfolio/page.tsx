...
const allProjects = [
{
  ...
  meta: [{ label: 'Industry', val: 'Consumer Goods' }, { label: 'Result', val: '+38% Recall' }]
},
{
  ...
  meta: [{ label: 'Units', val: '24 Homes' }, { label: 'Status', val: 'Completed' }]
},
{
  ...
  meta: [{ label: 'Value', val: '$2.4M GHS' }, { label: 'Timeline', val: '6 Weeks' }]
},
{
  ...
  meta: [{ label: 'Reach', val: '2.1M Impressions' }, { label: 'Duration', val: '3 Months' }]
},
{
  ...
  meta: [{ label: 'Floors', val: '3 Levels' }, { label: 'Status', val: 'Delivered' }]
},
{
  ...
  meta: [{ label: 'Service', val: 'Integrated' }, { label: 'Status', val: 'Delivered' }]
}];
    ...
    <>
      ...
      <div className="page-hero">
        <div className="page-hero-inner">
          ...
          <p>A showcase of our integrated solutions across marketing, real estate, and procurement.</p>
        </div>
      </div>
      {/* Portfolio Grid */}
      <section style={{ padding: '90px 0', background: 'var(--white)' }}>
        <div className="wrap">
          {/* Filter Buttons */}
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '44px', justifyContent: 'center' }} className="reveal">
            {categories?.map((cat) =>
            <button
              key={cat}
      ...
      <div style={{ background: 'linear-gradient(135deg,#071628 0%,#0b2d56 60%,#1361c4 100%)', padding: '80px 0' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 28px', textAlign: 'center' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,.62)', fontSize: '16px', marginBottom: '32px', lineHeight: 1.7 }}>
            Let&apos;s turn your vision into results. Our team is ready to build, brand, and deliver for you.
          </p>
