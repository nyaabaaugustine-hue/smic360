...
const PAGE_DESC =
  'Explore SMIC360 portfolio of completed projects across marketing, real estate development, and procurement in Ghana.';
...
const allProjects: Project[] = [
  ...
  },
  {
    ...
    result: '24',
    resultLabel: 'Units Delivered',
    tags: ['Gated Community', 'Accra', 'Residential'],
    meta: [
      { label: 'Units', val: '24 Homes' },
      { label: 'Status', val: 'Completed' },
      { label: 'Location', val: 'Spintex, Accra' },
    ],
    fullDesc:
      'The Phoenix Enclave Phase 1 is our flagship residential development in Community 20, Lashibi, off Spintex Road. We delivered 24 premium 3 and 4-bedroom homes with 24/7 security, landscaped gardens, and reliable utilities. All units were sold and occupied within 8 months of completion.',
  },
  {
  ...
  },
  {
    ...
    meta: [
      ...
      { label: 'Channels', val: 'TV · Digital · OOH' },
    ],
    fullDesc:
      'We designed and executed a full media buying strategy for a Tier 1 Ghanaian financial institution covering prime-time TV on GTV and TV3, targeted digital ads across Meta and Google, and OOH sites in Accra and Kumasi. The campaign delivered 2.1M verified impressions and a 22% uplift in branch enquiries.',
  },
  {
  ...
  },
  {
    ...
    result: '19%',
    resultLabel: 'Cost Saving',
    tags: ['Logistics', 'Office', 'Accra'],
    meta: [
      { label: 'Service', val: 'Integrated Supply' },
      { label: 'Saving', val: '19% vs Budget' },
      { label: 'Status', val: 'Delivered' },
    ],
    fullDesc:
      'Moonlight Shipping required a reliable procurement partner for their Accra office expansion covering IT infrastructure, office furniture, branded consumables, and operational equipment. By bundling across our pre-vetted vendor network, we achieved 19% savings against their original budget while cutting lead time by 3 weeks.',
  },
];
...
export default function PortfolioPage() {
  ...
  const catCount = (c: string) =>
    c === 'All' ? allProjects.length : allProjects.filter((p) => p.category === c).length;
  const filtered =
          ...
          >
            {[
              ...
              >
                ...
                >
                  {s.num}
                  <span style={{ color: '#FFC107' }}>{s.suf}</span>
                </div>
                <div
                  style={{
                    fontSize: 12,
      ...
      <section style={{ padding: '90px 0', background: 'var(--white)' }}>
        <div className="wrap">
          ...
          >
            ...
            <p className="section-sub" style={{ margin: 0, maxWidth: 380 }}>
              Click any project to read the full case study and results.
            </p>
          </div>
          ...
          <div className="pf-tabs reveal">
            {CATS.map((cat) => (
              <button
                key={cat}
                className={`pf-tab${active === cat ? ' on' : ''}`}
              ...
              <div key={i} className="pf-card" onClick={() => setModal(proj)}>
                ...
                <div className="pf-body">
                  ...
                  <div className="pf-cta">
                    <span className="pf-cta-t">
                      Read Case Study <span className="pf-cta-arr">&rarr;</span>
                    </span>
                    <span
                      style={{
                        fontSize: 11,
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              'linear-gradient(rgba(255,193,7,0.03) 1px,transparent 1px),linear-gradient(90deg,rgba(255,193,7,0.03) 1px,transparent 1px)',
        ...
        <div
          style={{
            ...
            height: 400,
            borderRadius: '50%',
            background: 'radial-gradient(circle,rgba(255,193,7,0.07),transparent)',
            top: '50%',
            left: '5%',
        ...
        >
          ...
          >
            Our team is ready to build, brand, and deliver for you. Book a free consultation with no
            obligation.
          </p>
          ...
          <p style={{ marginTop: 20, fontSize: 12, color: 'rgba(255,255,255,0.25)' }}>
            Or call us:{' '}
            <a href="tel:0244783099" style={{ color: '#FFC107', fontWeight: 700 }}>
              024 478 3099
            </a>
          </p>
        </div>
          ...
          >
            <div
              style={{
                ...
                animation: 'pfIn .36s cubic-bezier(.16,1,.3,1) both',
            ...
            >
              ...
              <div style={{ position: 'relative', height: 260, overflow: 'hidden' }}>
                ...
                <div
                  style={{
                    position: 'absolute',
                    inset: 0,
                    background: 'linear-gradient(transparent 30%,rgba(7,22,40,0.85))',
                  }}
                />
                <button
              ...
              <div
                style={{
                  display: 'grid',
                  gridTemplateColumns: `repeat(${modal.meta.length},1fr)`,
                  background: '#071628',
                  gap: 1,
                }}
              >
                {modal.meta.map((m, i) => (
                  <div
                    key={i}
                    style={{ padding: '14px 16px', textAlign: 'center', background: '#0b2240' }}
                  >
                    <div
                      style={{
                        fontFamily: 'Oswald,sans-serif',
              ...
              <div style={{ padding: '28px 30px' }}>
                ...
                <p style={{ fontSize: 15, color: '#5a7186', lineHeight: 1.82 }}>
                  {modal.fullDesc.split('\n\n').map((para, i) => (
                    <span
                      key={i}
                      style={{
                        display: 'block',
                        marginBottom: i < modal.fullDesc.split('\n\n').length - 1 ? 14 : 0,
                      }}
                    >
                      {para}
                    </span>
