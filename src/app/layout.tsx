...
export const metadata: Metadata = {
  ...
  description: "SMIC360 Limited: Ghana's leading multi-sector partner for Strategic Marketing, Real Estate Development (Phoenix Enclave), and Precision Procurement. Based in Accra, serving businesses across Ghana.",
  keywords: ['SMIC360', 'Ghana marketing agency', 'real estate Ghana', 'procurement Ghana', 'Phoenix Enclave Accra', 'branding Ghana', 'media buying Ghana'],
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Oswald:wght@400;500;600;700&family=Outfit:wght@300;400;500;600;700&family=Playfair+Display:ital,wght@0,700;1,700&display=swap" rel="stylesheet" />
        <script
