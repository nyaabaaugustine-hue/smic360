...
const galleryImages = [
  ...
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740050/IMG_9282_wurlft.jpg',
    caption: 'Main Entrance Gate',
    tag: 'Exterior',
    featured: true,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740050/IMG_9269_dwamrt.jpg',
    caption: 'Estate Overview',
    tag: 'Aerial',
    featured: true,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740051/IMG_9274_ycespr.jpg',
    caption: 'Residential Units',
    tag: 'Exterior',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740054/IMG_9272_mq8wja.jpg',
    caption: 'Landscaped Gardens',
    tag: 'Grounds',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740059/IMG_9276_yv0mxx.jpg',
    caption: 'Interior Living Room',
    tag: 'Interior',
    featured: true,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740085/IMG_9270_gd8psk.jpg',
    caption: 'Master Bedroom',
    tag: 'Interior',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740094/IMG_9280_idqvkd.jpg',
    caption: 'Modern Kitchen',
    tag: 'Interior',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740095/IMG_9283_pzuadx.jpg',
    caption: 'Dining Area',
    tag: 'Interior',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740100/IMG_9286_c23rad.jpg',
    caption: 'Bathroom & Finishes',
    tag: 'Interior',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740108/IMG_9277_xtj3z6.jpg',
    caption: 'Front Façade',
    tag: 'Exterior',
    featured: true,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740116/IMG_9287_wfqkka.jpg',
    caption: 'Private Parking',
    tag: 'Grounds',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740121/IMG_9296_fudrfg.jpg',
    caption: 'Street View',
    tag: 'Exterior',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740127/IMG_9290_sukybv.jpg',
    caption: 'Community Area',
    tag: 'Grounds',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740131/IMG_9292_wfk4t7.jpg',
    caption: 'Side Garden',
    tag: 'Grounds',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740132/IMG_9291_rmaxrk.jpg',
    caption: 'Rear Exterior View',
    tag: 'Exterior',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740133/IMG_9289_ppuvp4.jpg',
    caption: 'Building Details',
    tag: 'Exterior',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740134/IMG_9300_usbzke.jpg',
    caption: 'Utility Infrastructure',
    tag: 'Grounds',
    featured: false,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740134/IMG_9278_xnlknf.jpg',
    caption: 'Evening Ambience',
    tag: 'Exterior',
    featured: true,
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777740139/IMG_9304_orvwtw.jpg',
    caption: 'Construction Quality',
    tag: 'Exterior',
    featured: false,
  },
];
    ...
    >
      ...
      <div
        style={{
          ...
          padding: '14px 20px',
          background: 'linear-gradient(to bottom,rgba(2,6,18,.9),transparent)',
        }}
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLButtonElement).style.background = 'rgba(220,38,38,.65)';
          }}
          onMouseLeave={(e) => {
      ...
      {loaded && (
        <div
          onClick={(e) => e.stopPropagation()}
          style={{ padding: '14px 20px 8px', textAlign: 'center', flexShrink: 0 }}
        >
          <div
            style={{
              display: 'inline-flex',
      ...
      <div
        ...
        className="lb-thumbs"
        onClick={(e) => e.stopPropagation()}
        style={{ paddingBottom: 16, paddingTop: 8, flexShrink: 0 }}
      >
        {images.map((img, i) => (
...
export default function PhoenixEnclavePage() {
  ...
  const filtered =
    activeTag === 'All' ? galleryImages : galleryImages.filter((i) => i.tag === activeTag);
    ...
    <>
      ...
      <div className="page-hero">
        <div className="page-hero-inner">
          ...
          <h1>
            The Phoenix <em>Enclave</em>
          </h1>
          <p>
            A modern gated community designed for comfort, security, and long-term value — right in
            the heart of Greater Accra.
          </p>
        </div>
      </div>
          ...
          <div className="solutions-section-grid reveal">
            <div>
              ...
              <h2 className="section-title">
                Built for <em>Modern Living</em>
              </h2>
              <p className="section-sub">
                The Phoenix Enclave is SMIC360&apos;s premier real estate offering — a thoughtfully
                designed mini gated community offering residential and commercial spaces built with
                modern architecture, premium finishes, and a focus on long-term value for homeowners
                and investors.
              </p>
              <div
                style={{
              ...
              >
                {[
                  'Gated & Secured 24/7',
                  'Modern Architecture',
                  'Prime Accra Location',
                  'Premium Finishes',
                  'Investment-Grade ROI',
                  'Smart Home Ready',
                ].map((item, i) => (
                  <div
                    key={i}
              ...
              <div style={{ marginTop: '28px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <a href="tel:+233203361155" className="btn btn-outline">
                  📞 +233 20 336 1155
                </a>
              </div>
            </div>
      ...
      <div
        style={{
          background: 'var(--navy)',
          borderTop: '1px solid rgba(255,193,7,.12)',
          borderBottom: '1px solid rgba(255,193,7,.12)',
        }}
      >
        <div
          style={{
                ...
                {[
                  {
                    ...
                    desc: '24/7 security with controlled access — giving residents total peace of mind.',
                  },
                  {
                    icon: '🏛️',
                    title: 'Modern Architecture',
                    desc: 'Contemporary designs blending aesthetics with functionality, built to stand the test of time.',
                  },
                  {
                    icon: '📍',
                    title: 'Strategic Location',
                    desc: "Positioned in a serene locality with easy access to Accra's commercial and social hubs.",
                  },
                  {
                    icon: '💼',
                  ...
                  <div key={i} style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                    <div
                      style={{
                        ...
                        border: '1px solid rgba(13,61,154,.15)',
                        borderRadius: 12,
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
      ...
      >
        <div className="wrap">
          ...
          <div style={{ textAlign: 'center', marginBottom: 52 }} className="reveal">
            ...
            <h2 className="section-title">
              Explore Every <em>Corner</em>
            </h2>
            <p
              className="section-sub"
              style={{ textAlign: 'center', margin: '12px auto 0', maxWidth: 520 }}
            >
              {galleryImages.length} curated photographs from inside The Phoenix Enclave. Click any
              image to view full screen — use arrow keys or thumbnails to navigate.
            </p>
            {/* Progress bar */}
            <div
              style={{
            ...
            {TAGS.map(({ label, icon }) => {
              const count =
                label === 'All'
                  ...
                  : galleryImages.filter((i) => i.tag === label).length;
              return (
                <button
                  key={label}
                  type="button"
                  className={`enc-fb${activeTag === label ? ' active' : ''}`}
                  onClick={() => {
                    setActiveTag(label);
                    setLightbox(null);
                  }}
                >
                  <span>{icon}</span>
                  {label}
                  <span className="enc-fc">({count})</span>
                </button>
              );
            })}
          </div>
          ...
          <div className="enc-cs reveal">
            <p className="enc-ct">
              ...
              {activeTag === 'All' ? 'photos' : `${activeTag.toLowerCase()} photos`}
            </p>
            <button
              ...
              style={{
                ...
                border: 'none',
                cursor: 'pointer',
                boxShadow: '0 4px 14px rgba(7,22,40,.18)',
              }}
            >
            ...
            {filtered
              .filter(
                (img) =>
                  activeTag !== 'All' ||
                  !img.featured ||
                  galleryImages.filter((i) => i.featured).indexOf(img) >= 2
              )
              .map((img, i) => {
                const idx = filtered.indexOf(img);
                return (
            ...
            <div style={{ marginTop: 60, textAlign: 'center' }}>
              <div
                style={{
                  ...
                  alignItems: 'center',
                  gap: 14,
                  background: 'linear-gradient(135deg,rgba(7,22,40,.04),rgba(19,97,196,.06))',
                  border: '1.5px solid rgba(7,22,40,.08)',
                  borderRadius: 20,
                  padding: '32px 40px',
                }}
              >
                ...
                >
                  Seen enough? Let&apos;s get you a unit.
                </h3>
                <p
                  style={{
                    fontSize: 14,
                ...
                >
                  Limited units available in Phase 2. Book a private site visit or call our team
                  today.
                </p>
                <div
      ...
      >
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 28px', textAlign: 'center' }}>
          ...
          >
            Ready to{' '}
            <em style={{ fontStyle: 'normal', color: 'var(--cyan)' }}>Secure Your Unit?</em>
          </h2>
          <p
            style={{
          ...
          >
            Limited units available. Contact our team today for pricing, floor plans, and to
          ...
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="tel:+233203361155" className="btn btn-outline-white">
              📞 +233 20 336 1155
            </a>
          </div>
        </div>
