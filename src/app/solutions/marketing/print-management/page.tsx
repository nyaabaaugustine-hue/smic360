      ...
      services={[
        {
          ...
          desc: 'Banners, posters, backdrops, vehicle wraps, and large-scale signage for events, retail, and outdoor advertising.',
        },
        {
          icon: '📋',
          title: 'Corporate Stationery',
          desc: 'Business cards, letterheads, compliment slips, envelopes, and all branded office stationery.',
        },
        {
          icon: '📚',
          title: 'Brochures & Catalogues',
          desc: 'Product brochures, company profiles, sales catalogues, and annual reports printed to the highest standard.',
        },
        {
          icon: '🎁',
          title: 'Promotional & POS Materials',
          desc: 'Point-of-sale displays, promotional merchandise, branded gifts, and retail marketing materials.',
        },
        {
          icon: '📦',
          title: 'Packaging & Labels',
          desc: 'Product packaging, retail boxes, labels, and custom packaging solutions for FMCG and retail brands.',
        },
        {
          icon: '🔍',
          title: 'Print Procurement & Quality Control',
          desc: 'Supplier management, price negotiation, print specification, proofing, and quality inspection.',
        },
      ]}
      process={[
        {
          ...
          desc: 'We capture your print requirements, quantities, formats, and delivery timelines.',
        },
        {
          num: '02',
          title: 'Artwork Preparation',
          desc: 'Our designers prepare press-ready artwork, check colour profiles, and produce proofs for your approval.',
        },
        {
          num: '03',
          title: 'Production Management',
          desc: 'We manage the print run, QC at press, and ensure output meets your agreed specification.',
        },
        {
          num: '04',
          title: 'Delivery & Distribution',
          desc: 'We coordinate logistics and deliver your print materials on time to your required locations.',
        },
      ]}
