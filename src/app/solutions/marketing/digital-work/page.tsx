      ...
      services={[
        {
          ...
          desc: 'Corporate videos, TVCs, product demos, testimonials, and brand films produced to broadcast quality.',
        },
        {
          icon: '✨',
          title: 'Motion Graphics & Animation',
          desc: '2D motion graphics, explainer animations, kinetic typography, and animated social media content.',
        },
        {
          icon: '📸',
          title: 'Commercial Photography',
          desc: 'Product photography, corporate headshots, event coverage, and lifestyle images for campaigns.',
        },
        {
          icon: '🖥️',
          title: 'Interactive Digital Content',
          desc: 'Interactive infographics, digital lookbooks, HTML5 banners, and engaging web content formats.',
        },
        {
          icon: '🎞️',
          title: 'Social Media Content Production',
          desc: 'Reels, stories, short-form video series, and static posts produced at scale for all platforms.',
        },
        {
          icon: '🔊',
          title: 'Audio Production',
          desc: 'Jingles, podcast production, voiceovers, and branded audio assets for radio and digital.',
        },
      ]}
      process={[
        {
          ...
          desc: 'We workshop your objectives, audience, message, and vision to create a precise creative brief.',
        },
        {
          num: '02',
          title: 'Pre-production',
          desc: 'Scripting, storyboarding, casting, location scouting, and shoot planning.',
        },
        {
          num: '03',
          title: 'Production',
          desc: 'Professional shoot or animation production with our in-house and partner creative team.',
        },
        {
          num: '04',
          title: 'Post & Delivery',
          desc: 'Editing, colour grading, sound design, and delivery in all required formats and specifications.',
        },
      ]}
