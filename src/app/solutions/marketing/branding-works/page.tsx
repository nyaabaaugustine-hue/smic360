      ...
      services={[
        {
          ...
          desc: 'Distinctive logos and complete visual identity systems — colours, typography, iconography, and usage guidelines.',
        },
        {
          icon: '📋',
          title: 'Brand Strategy',
          desc: 'Positioning, brand voice, messaging architecture, and a strategic framework that differentiates you in your market.',
        },
        {
          icon: '📦',
          title: 'Packaging Design',
          desc: 'Eye-catching product and retail packaging that communicates quality and drives purchase at the point of sale.',
        },
        {
          icon: '🖨️',
          title: 'Brand Collateral',
          desc: 'Business cards, letterheads, brochures, signage, and all branded touchpoints that reinforce your identity.',
        },
        {
          icon: '📱',
          title: 'Digital Brand Assets',
          desc: 'Social media templates, email headers, web graphics, and all digital assets aligned to your brand system.',
        },
        {
          icon: '📖',
          title: 'Brand Guidelines',
          desc: 'Comprehensive brand style guides that ensure consistency across every channel, vendor, and team.',
        },
      ]}
      process={[
        {
          ...
          desc: 'We assess your current brand equity, competitor landscape, and audience perceptions.',
        },
        {
          num: '02',
          title: 'Strategy & Concept',
          desc: 'We develop positioning, messaging, and 2–3 creative directions for your review.',
        },
        {
          num: '03',
          title: 'Design & Refinement',
          desc: 'We craft the chosen direction into a full identity system with your feedback at each stage.',
        },
        {
          num: '04',
          title: 'Delivery & Rollout',
          desc: 'We deliver final files, guidelines, and support your brand launch across all channels.',
        },
      ]}
