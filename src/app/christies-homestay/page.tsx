...
const images = [
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777742699/1_1_csmex3.jpg',
    alt: "Christie's Homestay — Living Area",
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777742700/1_2_nciwfs.jpg',
    alt: "Christie's Homestay — Bedroom",
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777742700/1_4_qkl1ss.jpg',
    alt: "Christie's Homestay — Kitchen",
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777742700/1_3_joxw7a.jpg',
    alt: "Christie's Homestay — Dining Area",
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777742700/1_6_wrnqmu.jpg',
    alt: "Christie's Homestay — Bathroom",
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777742701/1_8_snv3sb.jpg',
    alt: "Christie's Homestay — Balcony",
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777742701/1_5_ckfuae.jpg',
    alt: "Christie's Homestay — Master Bedroom",
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777742702/1_7_bncntq.jpg',
    alt: "Christie's Homestay — Exterior",
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777742702/1_10_a6l5s3.jpg',
    alt: "Christie's Homestay — Pool Area",
  },
  {
    src: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777742702/1_9_dipy6a.jpg',
    alt: "Christie's Homestay — Night View",
  },
];
        ...
        {imgs.map((_, i) => (
          <button
            ...
            style={{
              ...
              height: 8,
              borderRadius: 4,
              background: i === cur ? '#FFC107' : 'rgba(255,255,255,0.3)',
              border: 'none',
              cursor: 'pointer',
        ...
        {!done ? (
          <>
            <div className="iq-head">
              <button className="iq-close" type="button" onClick={onClose}>
                ✕
              </button>
            ...
            <div className="iq-body">
              <form onSubmit={handleSubmit}>
                ...
                <div className="iq-group">
                  ...
                  <textarea
                    name="message"
                    placeholder="Airport pickup, specific room type, dietary needs…"
                  />
                </div>
                ...
                <p style={{ fontSize: 11.5, color: '#9ca3af', textAlign: 'center', marginTop: 10 }}>
                  🔒 We&apos;ll confirm within 2 hours. No payment required now.
                </p>
              </form>
            </div>
          </>
          ...
          <div style={{ padding: '52px 32px', textAlign: 'center' }}>
            ...
            >
              Thank you! Our team will confirm your booking at Christie&apos;s Homestay within 2
              hours.
            </p>
            <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <a
                href="https://api.whatsapp.com/send?phone=233244783099"
                target="_blank"
...
export default function ChristiesHomestayPage() {
  ...
  const faqs = [
    {
      ...
      a: 'Every stay includes fully furnished rooms with air conditioning, high-speed Wi-Fi, full kitchen access, smart TV, fresh bed linen & towels, and 24/7 security. Housekeeping is available on request.',
    },
    {
      q: 'How do I book a stay?',
      a: "Fill in the booking form on this page or WhatsApp us directly on 024 478 3099. We'll confirm availability and provide payment details within 2 hours.",
    },
    {
      q: 'What are the check-in / check-out times?',
      a: 'Standard check-in is from 2:00 PM and check-out by 11:00 AM. Early check-in and late check-out can be arranged subject to availability — just let us know in advance.',
    },
    {
      q: 'Is airport pickup available?',
      a: 'Yes! We offer airport pickup and drop-off to and from Kotoka International Airport. Please mention this when making your booking and we will arrange it for you.',
    },
    {
      q: 'What is your cancellation policy?',
      a: 'Cancellations made 72 hours or more before check-in receive a full refund. Cancellations within 48 hours may be subject to a one-night charge. Please contact us directly for flexibility on longer stays.',
    },
    {
      q: "Is Christie's Homestay suitable for families?",
      a: 'Absolutely. We accommodate families, solo travellers, couples, and corporate guests. The space comfortably fits up to 6 guests. Additional arrangements like extra beds or baby cots can be made on request.',
    },
  ];
  ...
  return (
    <>
      ...
      {lightbox !== null && (
        <Lightbox imgs={images} index={lightbox} onClose={() => setLightbox(null)} />
      )}
      ...
      <section className="ch-hero">
        ...
        <div className="ch-hero-content">
          ...
          <p className="ch-hero-sub">
            A beautifully furnished luxury apartment in the heart of Accra — perfect for business
            travellers, families, and holidaymakers seeking a home away from home.
          </p>
          ...
          <div className="ch-hero-ctas">
            ...
            <a
              href="https://api.whatsapp.com/send?phone=233244783099&text=Hi%2C%20I'm%20interested%20in%20Christie's%20Homestay"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <div>
              ...
              <div className="reveal" style={{ marginTop: 44 }}>
                ...
                <h2 className="section-title">
                  Luxury Living
                  <br />
                  <em>Made Affordable</em>
                </h2>
                <p className="section-sub" style={{ marginBottom: 18 }}>
                  Christie&apos;s Homestay is a premium fully-furnished short-stay rental managed by
                  SMIC360 Limited, located in a serene and secured gated compound on Spintex Road,
                  Accra.
                </p>
                <p
                  style={{
                ...
                >
                  Designed for the modern traveller — whether you&apos;re in Accra for business, a
                  family holiday, or an extended stay — our apartments combine hotel-level comfort
                  with the warmth and privacy of home. Every detail has been carefully curated to
                  ensure your stay is seamless, comfortable, and memorable.
                </p>
                <p
                  style={{
                    fontSize: 14.5,
                ...
                >
                  All units are fully air-conditioned, equipped with a complete kitchen, high-speed
                  Wi-Fi, and smart TV. Housekeeping is available on request, and our team is
                  available 24/7 to assist with any needs — from grocery stocking to airport
                  transfers.
                </p>
              ...
              <div className="reveal" style={{ marginTop: 44 }}>
                ...
                <div
                  style={{
                    ...
                    boxShadow: '0 12px 40px rgba(7,22,40,0.1)',
                  }}
                >
                  <video
                    src="https://res.cloudinary.com/dwsl2ktt2/video/upload/v1777742710/1_1_c7hlyk.mp4"
              ...
              <div className="ch-info-card reveal">
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: '#5a7186', marginTop: 2 }}>
                ...
                <div
                  style={{
                    background:
                      'linear-gradient(135deg,rgba(255,193,7,0.08),rgba(212,160,23,0.05))',
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: '#5a7186', marginTop: 4 }}>
                    Rates vary by season & duration
                  </div>
                </div>
                ...
                <a
                  href="https://api.whatsapp.com/send?phone=233244783099&text=Hi%2C%20I'd%20like%20to%20book%20Christie's%20Homestay"
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <div className="wrap">
          <div style={{ textAlign: 'center', marginBottom: 48 }} className="reveal">
            ...
            <p className="section-sub" style={{ textAlign: 'center', margin: '10px auto 0' }}>
              Every comfort you need — all included in your stay.
            </p>
          </div>
      ...
      <section className="ch-section">
        <div className="wrap">
          ...
          >
            {images.map((img, i) => (
              <div
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget.querySelector('img') as HTMLElement).style.transform =
                    'scale(1.08)';
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget.querySelector('img') as HTMLElement).style.transform =
              ...
              >
                ...
                <div
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.background = 'rgba(4,14,29,0.2)';
                  }}
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLElement).style.background = 'rgba(4,14,29,0)';
                  }}
                />
              </div>
            ))}
          ...
          <div style={{ textAlign: 'center', marginTop: 28 }}>
            <button onClick={() => setLightbox(0)} className="btn btn-primary">
              View Full Gallery →
            </button>
          </div>
        </div>
            ...
            {[
              {
                ...
                country: '🇬🇭 Ghana',
                stars: 5,
                text: "Perfect place for my corporate stay in Accra. Clean, spacious, great Wi-Fi, and the team was incredibly helpful. I'll definitely be back!",
              },
              {
                name: 'Sarah M.',
                country: '🇬🇧 UK',
                stars: 5,
                text: 'We stayed for 2 weeks and it felt like home. The kitchen was fully stocked on arrival, the pool was lovely, and the location is so convenient.',
              },
              {
                name: 'David O.',
                country: '🇳🇬 Nigeria',
                stars: 5,
                text: 'Great value for money compared to hotels. The airport pickup was arranged seamlessly and the apartment was immaculately clean. Highly recommend.',
              },
            ].map((r, i) => (
              <div
                key={i}
                style={{
                  ...
                  borderRadius: 18,
                  padding: '24px 22px',
                  boxShadow: '0 4px 20px rgba(7,22,40,0.06)',
                }}
              >
                <div
                  style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <div>
                    <div style={{ fontWeight: 700, fontSize: 13.5, color: '#071628' }}>
                      {r.name}
                    </div>
          ...
          >
            <div>
              ...
              <p className="section-sub" style={{ marginBottom: 24 }}>
                Christie&apos;s Homestay sits on the popular Spintex Road corridor — one of
                Accra&apos;s most accessible, well-developed, and convenient residential areas, just
                minutes from the city&apos;s key commercial hubs.
              </p>
              {[
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 14, color: '#071628', fontWeight: 600, marginTop: 2 }}>
                      {item.val}
                    </div>
                  </div>
                </div>
              ...
              <div style={{ display: 'flex', gap: 12, marginTop: 24, flexWrap: 'wrap' }}>
                <button onClick={() => setInquiryOpen(true)} className="btn btn-primary">
                  Book Now →
                </button>
                <a
                  href="https://maps.google.com/?q=Spintex+Road+Accra+Ghana"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn btn-outline"
                >
            ...
            <div
              style={{
                borderRadius: 20,
                overflow: 'hidden',
                boxShadow: '0 12px 40px rgba(7,22,40,0.14)',
                border: '2px solid #dce8f7',
                height: 400,
              }}
            >
              <iframe
                ...
                allowFullScreen
                loading="lazy"
                title="Christie's Homestay Location"
              />
            </div>
          </div>
        </div>
      ...
      <div className="ch-cta">
        ...
        >
          ...
          <span className="tag" style={{ color: 'var(--cyan)', justifyContent: 'center' }}>
            Book Your Stay
          </span>
          <h2
            style={{
          ...
          >
            Your <em style={{ fontStyle: 'normal', color: '#FFC107' }}>Home in Accra</em>
            <br />
            Awaits You
          </h2>
          <p
          ...
          >
            Whether you&apos;re visiting for a weekend or an extended stay — Christie&apos;s
            Homestay gives you the comfort, privacy, and service you deserve.
          </p>
      ...
      >
        ...
        >
          <div>
            ...
            >
              Also Looking to Buy Property in Accra?
            </div>
            <div style={{ fontSize: 14, color: '#5a7186', marginTop: 4 }}>
              Explore The Phoenix Enclave — SMIC360&apos;s premier gated residential development.
            </div>
          </div>
          <Link href="/the-phoenix-enclave" className="btn btn-primary">
            🏡 View The Phoenix Enclave →
          </Link>
        </div>
      </div>
