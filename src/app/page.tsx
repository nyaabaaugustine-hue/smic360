    ...
    <>
      ...
      <section style={{ padding: '90px 0', background: 'var(--off)' }}>
        <div className="wrap">
          ...
          <div className="reveal" style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', borderRadius: 'var(--r-lg)', boxShadow: 'var(--sh-lg)', border: '1px solid var(--border)', maxWidth: '1000px', margin: '0 auto' }}>
            <iframe 
          ...
          <div className="team-grid stagger">
            ...
            >
                <div className="team-card-socials">
                  ...
                  <a href="#" className="team-social-icon" onClick={(e) => e?.stopPropagation()}>tw</a>
                </div>
        ...
        <div className="wrap">
          <div className="testi-head reveal">
            ...
            <div style={{ textAlign: 'right' }}>
              <p style={{ fontSize: '14px', color: 'var(--muted)', maxWidth: '280px', lineHeight: '1.6', marginBottom: '12px' }}>
              ...
              <a href="https://www.google.com/search?q=SMIC360+LIMITED#lrd=0xfdf8402e54ac0bd:0x37c47d7434f4203c,3" target="_blank" rel="noopener noreferrer" className="btn btn-outline" style={{ fontSize: '12px', padding: '8px 16px' }}>
                <img src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg" style={{ width: '14px', marginRight: '8px', display: 'inline-block', verticalAlign: 'middle' }} alt="Google" />
                Write a Review
              </a>
            </div>
          </div>
        ...
        <div className="consult-inner reveal">
          ...
          {!consultDone ? (
            <form className="consult-form" onSubmit={handleConsult}>
              ...
              >{consultLoading ? 'Sending...' : 'Get Started →'}</button>
            </form>
          ) : (
            <p style={{ color: 'var(--cyan)', fontWeight: 600, fontSize: '16px', marginTop: '8px' }}>
