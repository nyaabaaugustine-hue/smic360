...
const clientLogos = [
  {
    src: clImg('https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777112814/a2_az567s.jpg', 200),
    alt: 'GCB Bank',
  },
  {
    src: clImg('https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777112816/a3_y1xfq2.jpg', 200),
    alt: 'MTN Ghana',
  },
  {
    src: clImg('https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777112818/a5_kpnhnw.jpg', 200),
    alt: 'Cocobod',
  },
  {
    src: clImg('https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777112820/a6_gelulp.jpg', 200),
    alt: 'GNPC',
  },
  {
    src: clImg('https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777112823/a7_bta0e1.jpg', 200),
    alt: 'Stanbic',
  },
  {
    src: clImg('https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777112830/a8_uhzxz6.jpg', 200),
    alt: 'ECG',
  },
  {
    src: clImg('https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777112843/a17_l3mpki.jpg', 200),
    alt: 'Ashfoam',
  },
];
...
const projects = [
  ...
  {
    img: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777872542/thisone-logo_x1cl2c.png',
    alt: 'Phoenix Enclave',
    badge: 'Real Estate',
    title: 'The Phoenix Enclave — Phase 1',
    desc: 'Delivery of Phase 1 of our flagship gated community — 24 residential units.',
    meta: [
  ...
  },
  {
    ...
    meta: [
      { label: 'Client', val: 'Haiflow S.A.L' },
      { label: 'Sector', val: 'Luxury Sanitary Ware' },
      { label: 'Outcome', val: 'Premium Positioning' },
    ],
    sections: [
      {
        heading: 'The Challenge',
        body: 'Haiflow entered a Ghanaian market that was largely price-sensitive, saturated with lower-cost alternatives, and driven by familiarity rather than product quality. The core challenge: how do you introduce a new entrant and justify premium pricing in a market dominated by cheaper options?',
      },
      {
        heading: 'Strategy',
        body: 'SMIC360 developed a 360° brand positioning and market penetration strategy focused on visibility, experience, and authority. Traditional media — newspaper and outdoor advertising — built credibility and reinforced brand presence. Experiential BTL activity centred on a curated showroom launch and exclusive brand events targeting architects, developers, and high-end clients, giving audiences direct access to the quality of the products.',
      },
      {
        heading: 'Industry & Thought Leadership',
        body: 'SMIC360 facilitated Haiflow’s participation in key industry events and exhibitions, embedding the brand within the professional ecosystem. The CEO was strategically positioned as an industry voice, elevating Haiflow from a product seller to a recognised authority in quality sanitary solutions.',
      },
      {
        heading: 'Results',
        body: 'Haiflow successfully established itself as a premium brand in the Ghanaian market — achieving strong positioning as a luxury sanitary ware provider, increased brand recognition among high-end audiences, and clear differentiation from lower-cost competitors. Haiflow S.A.L has grown into a recognised and respected name in Ghana’s premium sanitary ware space.',
      },
    ],
    extraImages: [
  ...
  {
    img: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777655037/360sm_mqzf0p.png',
    alt: 'Office Supply',
    badge: 'Procurement',
    title: 'Office Furniture & IT Equipment Supply',
    desc: 'Managed complete procurement and installation of office furniture and IT infrastructure.',
    meta: [
  ...
  },
  {
    ...
    meta: [
      { label: 'Client', val: 'Fox Cooling' },
      { label: 'Channels', val: 'Press · OOH · Radio · Digital' },
      { label: 'Outcome', val: 'Full MEP Recognition' },
    ],
    sections: [
      {
        heading: 'The Challenge',
        body: 'Fox Cooling was well-known in the market — but only within a narrow HVAC scope. After strategic restructuring to expand into full MEP services, the company needed to shift public perception without losing its existing brand equity. The core problem: how do you reposition a specialist into a full-scale solutions provider?',
      },
      {
        heading: 'Strategy',
        body: 'SMIC360 deployed a multi-channel awareness and reinforcement strategy across traditional, on-ground, and digital platforms. The campaign covered press and print media (full and half-page newspaper ads over two months), outdoor billboards on Spintex Road and Liberation Road, radio LPMs on Joy FM, Citi FM, and Atlantic FM, plus flyers and updated staff contact cards for front-line reinforcement.',
      },
      {
        heading: 'Digital & Industry Presence',
        body: "On the digital side, SMIC360 managed website updates, SEO, Google Ads, and social media across Instagram, Facebook, Twitter, LinkedIn, and YouTube Ads. The campaign was further amplified through sponsorships of industry events, exhibitions, and TV and online programmes — ensuring every touchpoint consistently reinforced Fox Cooling's new MEP identity.",
      },
      {
        heading: 'Results',
        body: "The campaign delivered increased awareness of Fox Cooling's expanded MEP services, stronger brand perception beyond HVAC, and better alignment between brand identity and actual service offerings. Fox Cooling evolved from being seen as an HVAC specialist to a recognised MEP solutions provider across its target markets.",
      },
    ],
    extraImages: [
...
const teamMembers = [
  {
    id: 'christiana',
    img: clImg(
      'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777112403/CHRISTIANA_pmwgsx.jpg',
      400
    ),
    name: 'Christiana',
    role: 'Founder & CEO',
    ...
    fullBio:
      "Christiana is the Founder and CEO of SMIC360 Limited. With over 20 years of industry experience, she has excelled in Advertising, Marketing, Business Management, and Hospitality. She also serves as Managing Director of Moonlight Shipping, Facility Manager of Christie's Homestay, Project Manager of The Phoenix Enclave, and Business Manager for Eagle EL Salt Ghana Limited and Osabusquare.",
  },
  {
    id: 'alberta',
    img: clImg(
      'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777112403/ALBERTA_jbrc1f.jpg',
      400
    ),
    name: 'Alberta',
  ...
  },
  {
    id: 'samuel',
    img: clImg(
      'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777112169/NII-BOYE_mixzve.jpg',
      400
    ),
    name: 'Samuel',
    ...
    fullBio:
      'Samuel is a dynamic Creative & Production Manager with over 15 years of experience and a BFA in Publishing. He leads the creative team in delivering innovative and impactful marketing solutions, crafting visually captivating campaigns that drive client success.',
  },
];
...
function CtaBanner({ onBook }: { onBook: () => void }) {
  ...
  const handleDownload = (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    setTimeout(() => {
      setDlState('done');
      window.open(
        'https://drive.google.com/file/d/1wrGYrHFkH5t9H4DT0B_rnDYkdFifEqvn/view?usp=sharing',
        '_blank'
      );
      ...
      >
        <div style={{ flex: '1 1 400px' }}>
          ...
          >
            Scale Your Business
            <br />
            with Our <em style={{ fontStyle: 'normal', color: '#FFC107' }}>2025 Catalogue</em>
          </h2>
          <p
            style={{
  ...
  const processSteps = [
    {
      icon: '📚',
      title: 'Consultancy',
      subtitle: 'Stage 1 — When Applicable',
      desc: 'Agency meets with client to assess needs and agree on budget and implementation schedule. Initial research is carried out after which ideas, findings and recommendations are presented with an implementation plan. Agency implements and monitors all activities regarding the recommendation, then presents a performance report to client for evaluation.',
    },
    {
      icon: '🎨',
      title: 'Concept & Layout',
      subtitle: 'Stage 2 — Creative & Media',
      desc: 'Following stage one, a media campaign is mounted. Agency comes up with concepts and layouts, PR interventions or media placement tailored specifically to client goals and budget.',
    },
    {
      icon: '📦',
      title: 'Service Package',
      subtitle: 'Pay Per Project or Retainer',
      desc: 'Clients choose between Pay Per Project (each project individually, e.g. concepts, PR services, advisory) or one of our Retainer packages — Creative, Marketing, Media/PR, or General — paid as a flat fee for an agreed period with no extra charges.',
    },
    {
      icon: '🤝',
      title: 'Delivery & Report',
      subtitle: 'Evaluation & Ongoing Support',
      desc: 'Agency implements and monitors all activities, then presents a full performance report to client. We work together as family — management staff, clients, and suppliers all working together to ensure maximum satisfaction and value.',
    },
  ];

  const properties = [
    {
      img: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777870096/2bed-logo_argqxq.png',
      title: 'Phoenix Enclave — 2 Bedroom',
      type: 'Residential',
      beds: 3,
      baths: 2,
      area: '180 m²',
    ...
    {
      img: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777870096/2bed-logo_1_somx5l.png',
      title: 'Phoenix Enclave — 3 Bedroom',
      type: 'Luxury Villa',
      beds: 5,
      baths: 4,
      area: '380 m²',
    ...
    {
      img: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777870093/2bed-logo_2_crh9xp.png',
      title: 'Phoenix Enclave — 4 Bedroom',
      type: 'Commercial',
      beds: 0,
      baths: 2,
      area: '260 m²',
    ...
    <>
        ...
        <div className="stats-ribbon-inner stagger">
          {[
            ...
            { num: 80, suffix: '+', label: 'Happy Clients', desc: 'Across Ghana & West Africa' },
            {
              ...
              desc: 'Established since 2006, Accra',
            },
            {
              num: 3,
              suffix: '',
              label: 'Core Services',
              desc: 'Marketing · Real Estate & Hospitality · Procurement',
            },
          ].map((s, i) => (
            <div key={i} className="stats-item">
              <div className="stats-num" style={{ color: '#fff' }}>
                <AnimCounter target={s.num} suffix="" />
                <span style={{ color: '#FFC107' }}>{s.suffix}</span>
              </div>
            ...
            {[
              {
                ...
                desc: 'Laying the Foundation for Brand Power & Market Dominance We provide a comprehensive ecosystem of creative and strategic services designed to build powerful, memorable brands that achieve sustainable growth. .',
              },
              {
                icon: '🏗️',
                title: 'Real Estate Development',
                desc: 'Transforming Potential into Premium Assets Our real estate division focuses on the full lifecycle of property development and asset management, ensuring architectural excellence and maximum investment value. ',
              },
              {
                icon: '📦',
                title: 'Procurement & Supply Solutions',
                desc: 'Streamlining Global Sourcing with Precision and Reliability We act as your dedicated sourcing partner, simplifying complex supply chains to deliver high-quality materials and equipment at competitive prices. ',
              },
            ].map((s, i) => (
          ...
          <div className="about-grid">
            ...
            <div className="about-text reveal-right">
              ...
              <h2 className="section-title">
                Our Core Solutions — <em>A Fully Integrated 360° Approach</em>
              </h2>
              <p className="section-sub">
                At SMIC360, we drive growth by aligning strategy with execution across three
                critical business pillars. We eliminate fragmentation by providing seamless,
                results-driven experiences across the entire value chain.{' '}
              </p>
      ...
      <div className="ghana-strip">
        <div className="ghana-strip-inner">
          <div className="ghana-strip-text">
            <h3>
              From strategy to execution, SMIC360 drives visibility, consistency, and real business
              growth.
            </h3>
            <p>
              SMIC360 is headquartered in Accra
            </p>
          </div>
          <div
            style={{
          ...
          >
            ...
            <button onClick={openBook} className="btn btn-outline-white">
              Partner With Us
            </button>
          </div>
        </div>
            ...
            <div className="vt-frame-inner">
              ...
              <div className="vt-chrome">
                ...
                <div className="vt-url">
                  youtube.com — The Phoenix Enclave Virtual Tour · SMIC360 Real Estate
                </div>
              ...
              <div className="vt-caption">
                <div className="vt-caption-l">
                  ...
                  <div>
                    ...
                    <span className="vt-cap-sub">
                      Spintex Road, Accra, Ghana · SMIC360 Real Estate Division
                    </span>
                  </div>
                </div>
            ...
            {[
              {
                ...
                alt: 'Brand Strategy',
                title: 'Advertising & Marketing',
                desc: 'We provide a comprehensive ecosystem of creative and strategic services designed to build powerful,... ',
                href: '/solutions',
              },
              {
                ...
                alt: 'Real Estate',
                title: 'Real Estate Development',
                desc: 'Our real estate division focuses on the full lifecycle of property development and asset management, ensuring ...',
                href: '/solutions',
              },
              {
                img: 'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777655037/360sm_mqzf0p.png',
                alt: 'Procurement',
                title: 'Procurement & Supply Solutions',
                desc: 'We act as your dedicated sourcing partner, simplifying complex supply chains to deliver high-quality ...',
                href: '/solutions',
              },
            ].map((cap, i) => (
      ...
      <section
        ...
        style={{
          position: 'relative',
          padding: '100px 0',
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.85)), url('https://res.cloudinary.com/dwsl2ktt2/image/upload/v1776533938/e21881a3_vb8pcu.jpg')`,
          backgroundSize: 'cover',
          backgroundPosition: 'center',
      ...
      >
        <div className="wrap">
          <div style={{ textAlign: 'center', marginBottom: '52px' }} className="reveal">
            ...
            >
              From consultancy to concept, package to delivery — a structured approach that ensures
              every client gets maximum value.
            </p>
          </div>
          ...
          <div className="feat-grid">
            ...
            <div className="reveal-right">
                ...
                {[
                  {
                    ...
                    desc: '24/7 security, controlled access, and a peaceful neighbourhood environment.',
                  },
                  {
                    icon: '🏛️',
                    title: 'Modern Architecture',
                    desc: 'Contemporary designs that blend aesthetics with functionality — built to last.',
                  },
                  {
                    icon: '📍',
                    title: 'Strategic Location',
                    desc: "Positioned in a serene locality with convenient access to Accra's key commercial hubs.",
                  },
                  {
                    icon: '💼',
                    title: 'Investment Opportunity',
                    desc: "High ROI potential in one of Ghana's fastest-growing real estate corridors.",
                  },
                ].map((item, i) => (
              ...
              <div style={{ marginTop: '28px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={openBook} className="btn btn-outline">
                  Book a Site Visit
                </button>
              </div>
            </div>
        ...
        <div className="wrap">
          <div style={{ textAlign: 'center' }} className="reveal">
            ...
            <p className="section-sub" style={{ margin: '12px auto 0', textAlign: 'center' }}>
              A dedicated team of strategists, creatives, engineers, and specialists — united by one
              goal: your success.
            </p>
          </div>
        ...
        <div className="wrap">
          <div className="testi-head reveal">
            ...
            <div style={{ textAlign: 'right' }}>
              ...
              >
                Real results. Real clients. Real growth stories.
              </p>
              <a
              ...
              <div className="hq-details">
                {[
                  ...
                  },
                  {
                    icon: '✉️',
                    title: 'Email',
                    desc: 'christie@smic360.com — Expect a reply within 2 business hours',
                  },
                  {
                    icon: '🕐',
                    title: 'Office Hours',
      ...
      <section className="consult">
        <div className="consult-inner reveal">
          ...
          <h2 className="consult-title">
            Start With A <em>Free Advertising Consultation</em>
          </h2>
          <p className="consult-sub">
            Tell us about your business and marketing needs. We will assess your requirements and
            present recommendations with an implementation plan — at no obligation.
          </p>
          {!consultDone ? (
