                  ...
                  <form onSubmit={handleSubmit} style={{display:'grid',gap:'16px'}}>
                    ...
                    <div className="form-row">
                      ...
                      <div className="form-group">
                        ...
                        <input type="tel" name="phone" placeholder="e.g. 024 478 3099" pattern="[0-9\s+]{10,15}" title="Please enter a valid phone number" />
                      </div>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <textarea name="message" placeholder="Tell us about your project or need..." style={{height:'120px',resize:'none'}}></textarea>
                    </div>
                    <button 
                      type="submit" 
