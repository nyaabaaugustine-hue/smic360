    ...
    <>
      ...
      {mounted &&
        ...
        createPortal(
          <>
            ...
            <div
              onClick={(e) => {
                if (e?.target === e?.currentTarget) setTeamModal(null);
              }}
              style={{
                position: 'fixed',
                inset: 0,
            ...
            >
              ...
              >
                ...
                <div
                  style={{ padding: '28px 32px', color: '#5a7186', lineHeight: 1.82, fontSize: 15 }}
                >
                  {teamModal.fullBio}
                </div>
              </div>
      ...
      <div className="page-hero">
        <div className="page-hero-inner">
          ...
          <h1>
            Building <em>Legacies</em>
          </h1>
          <p>
            SMIC360 Limited — the Preferred Advertising Agency in Ghana &amp; Beyond. Our story is
            one of creativity, professionalism, and transformative impact across Ghana&apos;s
            business landscape.
          </p>
        </div>
      </div>
          ...
          >
            ...
            <div className="reveal-left" style={{ position: 'relative' }}>
              <div
                style={{
                  borderRadius: 20,
                  overflow: 'hidden',
                  boxShadow: '0 24px 64px rgba(7,22,40,0.14)',
                  position: 'relative',
                }}
              >
                <img
                ...
                <div
                  style={{
                    position: 'absolute',
                    inset: 0,
                    background: 'linear-gradient(to top, rgba(7,22,40,0.72) 0%, transparent 55%)',
                  }}
                />
                {/* Tagline on image */}
              ...
              <div
                style={{
                  ...
                  padding: '18px 22px',
                  textAlign: 'center',
                  boxShadow: '0 8px 28px rgba(19,97,196,.38)',
                  zIndex: 2,
                }}
              >
                <span
            ...
            <div className="reveal-right">
              ...
              <h2 className="section-title">
                A Fully Integrated <em>360° Approach</em>
              </h2>
                ...
                {[
                  {
                    ...
                    sub: 'Laying the Foundation for Brand Power',
                  },
                  {
                    num: 'II.',
                    color: '#1261c0',
                    title: 'Real Estate & Hospitality',
                    sub: 'Transforming Potential into Premium Assets',
                  },
                  {
                    num: 'III.',
                    color: '#16a34a',
                    title: 'Procurement & Supply Solutions',
                    sub: 'Streamlining Global Sourcing',
                  },
                ].map((p, i) => (
                  <div
                    key={i}
            ...
            {[
                ...
                items: [
                  {
                    ...
                    desc: 'We define your path to success through brand positioning, market entry strategies, and data-informed business advisory.',
                  },
                  {
                    title: 'Branding & Creative',
                    desc: 'Our team crafts compelling corporate identities and visual communication designs that resonate across digital and traditional platforms.',
                  },
                  {
                    title: 'Campaign Execution',
                    desc: 'We bring ideas to life through integrated marketing, leveraging social media, search, and high-impact experiential activations.',
                  },
                  {
                    title: 'Media & Production',
                    desc: 'We maximize your reach through expert media buying, out-of-home (OOH) execution, and high-quality print management.',
                  },
                ],
              },
              {
                ...
                items: [
                  {
                    title: 'Property Development & Strategic Sales',
                    desc: 'We manage everything from land acquisition and project feasibility to the construction of modern residential and commercial complexes.',
                  },
                  {
                    title: 'Property Leasing & Asset Management',
                    desc: 'We specialize in the curation of premium rental portfolios, including furnished apartments and executive stays.',
                  },
                  {
                    title: 'Operational Excellence',
                    desc: 'Our services include rigorous tenant screening, lease administration, and proactive maintenance to preserve long-term asset value.',
                  },
                  {
                    title: 'Hospitality Services',
                    desc: 'We provide concierge-level support for short-term rentals and guest services.',
                  },
                ],
              },
              {
                ...
                items: [
                  {
                    title: 'Strategic Sourcing & Cost Efficiency',
                    desc: 'Leverage our extensive network to secure the best suppliers and negotiate competitive pricing, reducing your operational costs.',
                  },
                  {
                    title: 'Quality & Reliability',
                    desc: 'We prioritize stringent quality assurance and coordinate complex logistics to ensure every item is delivered on time and to specification.',
                  },
                  {
                    title: 'Industrial & Commercial',
                    desc: 'Machinery, specialized tools, and safety equipment (PPE).',
                  },
                  {
                    title: 'Construction Materials',
                    desc: 'High-grade cement, steel, roofing, and electrical fittings.',
                  },
                  {
                    title: 'Bulk Commodities',
                    desc: 'Industrial and edible salt, and diverse raw materials for manufacturing.',
                  },
                  {
                    title: 'Household & Specialized Items',
                    desc: 'Premium appliances, hard-to-find components, and custom-order products.',
                  },
                ],
              },
            ].map((pillar, pi) => (
              <div
                ...
                style={{
                  background: '#fff',
                  borderRadius: 20,
                  border: `1px solid ${pillar.borderCol}`,
                  overflow: 'hidden',
                  boxShadow: '0 4px 24px rgba(7,22,40,0.07)',
                  display: 'flex',
                  flexDirection: 'column',
              ...
              >
                ...
                <div
                  style={{
                    ...
                    borderBottom: `1px solid ${pillar.borderCol}`,
                    padding: '20px 22px',
                    display: 'flex',
                    alignItems: 'center',
                    gap: 14,
          ...
          <div className="stats-grid">
            {[
              ...
              <div key={i} style={{ textAlign: 'center', padding: '8px' }}>
                ...
                >
                  {stat.num}
                  <span style={{ color: '#FFC107' }}>{stat.suffix}</span>
                </div>
                <div
                  style={{
                    fontSize: '13px',
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              'radial-gradient(circle at 20% 50%, rgba(212,160,23,0.05) 0%, transparent 60%), radial-gradient(circle at 80% 20%, rgba(18,97,192,0.05) 0%, transparent 60%)',
            pointerEvents: 'none',
          }}
        />
        ...
        <div className="wrap" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '60px' }} className="reveal">
            ...
            <h2 className="section-title">
              Our Commitment to <em>Global Goals</em>
            </h2>
            <p
              className="section-sub"
              style={{ margin: '16px auto 0', textAlign: 'center', maxWidth: '680px' }}
            >
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: 20,
                    overflow: 'hidden',
                    boxShadow: '0 12px 40px rgba(7,22,40,0.15)',
                  ...
                  onMouseEnter={(e) => {
                    ...
                    (e.currentTarget as HTMLDivElement).style.boxShadow =
                      '0 24px 60px rgba(7,22,40,0.22)';
                  }}
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLDivElement).style.transform = '';
                    (e.currentTarget as HTMLDivElement).style.boxShadow =
                      '0 12px 40px rgba(7,22,40,0.15)';
                  }}
                >
                  <img
                    src={sdg.img}
          ...
          <div className="values-grid stagger" style={{ marginBottom: '64px' }}>
            ...
            >
              ...
              <div style={{ padding: '32px 28px', flex: 1 }}>
                ...
                <p style={{ fontSize: 14, color: 'var(--muted)', lineHeight: 1.78 }}>
                  As a{' '}
                  <strong style={{ color: 'var(--text)' }}>woman-owned and funded company</strong>,
                  our foundation is built on the principles of gender equality. We are dedicated to
                  ensuring equal opportunities and fair representation within our team, and we
                  advocate for diversity and inclusion across the industries we serve. We believe
                  that empowering all individuals is essential for sustainable growth.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div style={{ padding: '32px 28px', flex: 1 }}>
                ...
                <p style={{ fontSize: 14, color: 'var(--muted)', lineHeight: 1.78 }}>
                  We contribute to economic prosperity by creating{' '}
                  <strong style={{ color: 'var(--text)' }}>
                    meaningful employment opportunities
                  </strong>{' '}
                  and fostering a positive and inclusive work environment. Through our core business
                  — delivering efficient advertising, innovative real estate solutions, and reliable
                  procurement services — we drive business success for our clients, thereby fueling
            ...
            >
              ...
              <div style={{ padding: '32px 28px', flex: 1 }}>
                ...
                <p style={{ fontSize: 14, color: 'var(--muted)', lineHeight: 1.78 }}>
                  Our work directly supports the development of{' '}
                  <strong style={{ color: 'var(--text)' }}>
                    sustainable industries and resilient infrastructure
                  </strong>
                  . We continuously innovate to improve our processes and provide cutting-edge
                  solutions. Our real estate and procurement projects contribute to building the
                  infrastructure that supports a thriving and modern economy.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 1, flex: 1, minWidth: 280 }}>
              ...
              >
                Connect with us on our mission to
                <br />
                <em style={{ fontStyle: 'normal', color: '#FFC107' }}>bring change to the world</em>
            ...
            >
              <Link
                ...
                style={{ fontSize: 14, padding: '14px 28px', whiteSpace: 'nowrap' }}
              >
                Contact Us →
              </Link>
              <Link
        ...
        <div className="wrap">
          ...
          <div style={{ textAlign: 'center', marginBottom: '48px' }} className="reveal">
            ...
            <p className="section-sub" style={{ margin: '12px auto 0', textAlign: 'center' }}>
              A dedicated team of strategists, creatives, and specialists united by one goal — your
              success.
            </p>
          </div>
