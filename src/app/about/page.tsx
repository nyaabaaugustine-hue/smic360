    ...
    <>
      ...
      <div className="page-hero">
        <div className="page-hero-inner">
          ...
          <p>
            Our story is one of innovation, integrity, and transformative impact across Ghana&apos;s
            business landscape.
          </p>
        </div>
      </div>
                ...
                {[
                  {
                    ...
                    desc: 'Data-driven campaigns and forward-thinking solutions tailored to your market.',
                  },
                  {
                    icon: '🏗️',
                    title: 'Premium Developments',
                    desc: 'Quality-built spaces designed for modern Ghanaian living and investment.',
                  },
                  {
                    icon: '📦',
                    title: 'End-to-End Procurement',
                    desc: 'Efficient sourcing and supply chain management for every business need.',
                  },
                  {
                    icon: '🤝',
                    title: 'Client-Centric',
                    desc: 'Partnerships built on trust, transparency, and measurable results.',
                  },
                ].map((pt, i) => (
            ...
            {[
              {
                ...
                desc: 'Every solution starts with a tailored strategy built around your unique goals, market context, and growth ambitions.',
              },
              {
                icon: '🏆',
                title: 'Excellence in Delivery',
                desc: 'We hold ourselves to the highest standards of quality, precision, and professionalism in every project we undertake.',
              },
              {
                icon: '🌍',
                title: 'Ghana-Rooted Vision',
                desc: 'Built in Accra with deep local expertise and a pan-African perspective for everything we build and create.',
              },
            ].map((val, i) => (
              <div
                key={i}
      ...
      <section id="sdgs" style={{ padding: '90px 0', background: 'var(--white)' }}>
        <div className="wrap">
          <div style={{ textAlign: 'center', marginBottom: '48px' }} className="reveal">
            ...
            <h2 className="section-title">
              Committed to <em>Sustainable Development</em>
            </h2>
            <p className="section-sub" style={{ margin: '12px auto 0', textAlign: 'center' }}>
              At SMIC360, we align our operations with the UN Sustainable Development Goals to
              create lasting impact in Ghana.
            </p>
          </div>
          <div className="values-grid stagger">
            {[
              {
                ...
                desc: 'Developing resilient infrastructure through The Phoenix Enclave and fostering innovation in marketing.',
              },
              {
                icon: '💼',
                title: 'Goal 8: Decent Work',
                desc: 'Providing professional growth opportunities and contributing to Ghanaian economic growth.',
              },
              {
                icon: '🤝',
                title: 'Goal 17: Partnerships',
                desc: 'Collaborating across sectors—from banking to state enterprises—to achieve integrated success.',
              },
            ].map((sdg, i) => (
              <div
                key={i}
